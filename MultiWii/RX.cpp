...
//RAW RC values will be store here
  ...
  static uint8_t rcChannel[RC_CHANS] = {PITCH,YAW,THROTTLE,ROLL,AUX1,AUX2,AUX3,AUX4,8,9,10,11};
      ...
      // See koht defineerib ära antud hetkel saada olevad kanalid
...
// Siin defineeritakse data täitsa ära, siit saab muuta channelite sisu jne
uint16_t readRawRC(uint8_t chan) {
  uint16_t data;
    ...
    // Siin on if klausel mis peaks muutma pitchpini väärtuse 2000
