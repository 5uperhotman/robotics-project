...
//Siin koodis vaadata rida 636

//ultrahelisensori sisend defineeritatkse siin, sensori arduino saadab välja kas low või high signaali
...
//Siin defineeritatkse ära sensorpin, milleks on pin12, sinna tuleb kas low või high signaal
...
void loop () {
  ...
  if ((int16_t)(currentTime-rcTime) >0 ) { // 50Hz
    ...
    rcSticks = stTmp;
    //SIIT SAAB MUUTA RECEIVER VÄÄRTUSI ##################################
    // perform actions    
    ...
    if(rcDelayCommand == 20) {
      if(f.ARMED) {                   // actions during armed
        ...
        #endif                                                            // Proovida ka siit muuta asju 
        #ifdef MULTIPLE_CONFIGURATION_PROFILES
